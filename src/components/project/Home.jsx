      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="relative flex flex-col lg:flex-row justify-left items-center lg:space-x-8">
          ...
          <div className="w-full lg:w-1/2 relative">
            <img src="/img/desktop.png"  // Replace with your desktop mockup image
              alt="Desktop Mockup"
...
I’m passionate about creating clean UIs and learning something new with every project. Open to junior dev roles and collaborations 
</p><button className="mt-6 px-6 py-3 bg-white text-purple-500 rounded-lg shadow-lg hover:bg-gray-200">
              View Projects
            </button>
          </div>
        </div>
